  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16 ">
        ...
        <div>
          <p className="mt-5 flex flex-col gap-3 text-slate-500 text-justify">
            I have worked with all sorts of clients and projects, levelling up
            my skills amd teaming up with smart colleagues and senior
            developers. Her's the rundown:
          </p>
        </div>
